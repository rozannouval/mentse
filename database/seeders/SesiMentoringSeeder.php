...
class SesiMentoringSeeder extends Seeder
{
    public function run(): void
    {
        ...
        SesiMentoring::create(['kelas_id' => 3, 'topik' => 'Binary Search Tree', 'deskripsi' => 'Pembahasan BST dan implementasinya', 'tanggal' => '2026-06-10', 'jam_mulai' => '10:00', 'jam_selesai' => '12:00', 'kuota' => 5, 'status' => 'selesai']);
        ...
        SesiMentoring::create(['kelas_id' => 4, 'topik' => 'Normalisasi Database', 'deskripsi' => 'Pembahasan normalisasi database hingga 3NF', 'tanggal' => '2026-09-01', 'jam_mulai' => '09:00', 'jam_selesai' => '11:00', 'kuota' => 5, 'status' => 'dibuka']);
    }
}
